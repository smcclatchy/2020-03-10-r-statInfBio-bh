...
collaborative_notes: https://pad.carpentries.org/2020-03-10-statInf-bh
...
<p id="where">
  <strong>Where:</strong>
  Breezeway Bioinformatics Training Room, bldg 1, unit 5, {{page.address}}.
  Get directions with
